...
ActiveRecord::Schema[8.0].define(version: 2026_03_16_230017) do
  ...
  create_table "author_fee_calculators", force: :cascade do |t|
  ...
  create_table "service_contract_calculators", force: :cascade do |t|
    t.integer "amount_in_cent", default: 0
    t.string "calculation_type", default: "brut-to-net"
    t.integer "city_tax_rate_id"
    t.integer "user_id"
